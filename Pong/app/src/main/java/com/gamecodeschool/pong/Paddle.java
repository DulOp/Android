...
public class Paddle {
    ...
    // X is the far left of the rectangle which forms the mPaddle
    ...
    // Which way can the mPaddle move
    ...
    public void update(long fps) {
        ...
        if (mRect.right > mScreenY) {
            mXCoord = mScreenX - (mRect.right - mRect.left); // The width of the paddle
        }
